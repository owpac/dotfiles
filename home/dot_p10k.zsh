# Generated by Powerlevel10k configuration wizard on 2026-01-13 at 17:02 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND=141
  # typeset -g POWERLEVEL9K_TERRAFORM_OTHER_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #############[ terraform_version: terraform version (https://www.terraform.io) ]##############
  # Terraform version color.
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND=141
  # Custom icon.
  ...
  function prompt_mise() {
    ...
    for plugin in ${(k)plugins}; do
      ...
      local tool=${(U)tool_name}
      local version=${parts[2]}

      # Only display if the tool is in the allowed list (or if list is empty, display all)
      if [[ ${#POWERLEVEL9K_MISE_TOOLS[@]} -eq 0 ]] || (( ${POWERLEVEL9K_MISE_TOOLS[(Ie)$tool_name]} )); then
        p10k segment -r -i "${tool}_ICON" -s $tool -t "$version"
      fi
    done
  }

  # List of mise tools to display in prompt (empty = display all)
  # Only show programming languages and infrastructure tools, exclude utility tools like ggshield, prettier, etc.
  typeset -g POWERLEVEL9K_MISE_TOOLS=(
    # Programming languages
    ruby python golang go node nodejs rust dotnet-core dotnet flutter lua java perl erlang elixir php haskell julia
    scala kotlin swift dart r zig nim crystal ocaml clojure fsharp groovy
    # Infrastructure & DevOps tools
    terraform kubectl helm ansible docker-compose packer vagrant
  ...
  # Reuse ASDF colors for mise (evaluated at source time)
  ...
  typeset -g POWERLEVEL9K_MISE_NODE_FOREGROUND=$POWERLEVEL9K_ASDF_NODEJS_FOREGROUND
  ...
  # Tools without ASDF equivalent use native p10k colors
  typeset -g POWERLEVEL9K_MISE_TERRAFORM_FOREGROUND=$POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND
