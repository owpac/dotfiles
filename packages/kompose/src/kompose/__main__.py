...
Commands:
    ...
    env check    Check .env drift (read-only)
...
Examples:
  ...
  kompose env check             Check .env drift (read-only)
...
""",
    ...
    up_parser.add_argument("containers", nargs="*", metavar="<container>", help="Specific containers within the service")
    ...
    down_parser.add_argument("containers", nargs="*", metavar="<container>", help="Specific containers within the service")
    down_parser.set_defaults(func=cmd_down)

    # restart
    restart_parser = subparsers.add_parser("restart", help="Restart services")
    restart_parser.add_argument("service", nargs="?", metavar="<service>", help="Service to restart (default: all)")
    restart_parser.add_argument("containers", nargs="*", metavar="<container>", help="Specific containers within the service")
    restart_parser.set_defaults(func=cmd_restart)

    # logs
    logs_parser = subparsers.add_parser("logs", help="View service logs")
    logs_parser.add_argument("service", metavar="<service>", help="Service to view logs")
    logs_parser.add_argument("containers", nargs="*", metavar="<container>", help="Specific containers within the service")
    ...
    status_parser.add_argument("-s", "--stats", action="store_true", help="Show memory usage stats")
    ...
    check_parser = env_subparsers.add_parser("check", aliases=["c"], help="Check .env vs .env.example (read-only)")
    check_parser.add_argument("service", nargs="?", metavar="<service>", help="Service to check (default: all)")
